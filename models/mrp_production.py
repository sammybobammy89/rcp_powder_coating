...
class MrpProduction(models.Model):
    ...
    # This method is copied directly from community mrp production
    # the following line has been commented out below
    # self.env['stock.move.line'].browse(move_lines_to_unlink).write({'move_id': False})
    # settting move_id to false creates error when executing next line
    # this function does not appear to be used elsewhere
